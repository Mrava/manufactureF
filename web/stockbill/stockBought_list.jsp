...
function add()
{
	var url = "/stockBought!addBatch.action";
	self.location = url;
}
...
<div class="listtit">
	...
	<a href="javascript:add()">批量添加</a>	
	<a href="javascript:singleAdd();">添加</a>
</div>
...
<div class="gopage" style="margin-right:10px;margin-bottom:5px;">
		...
		<b onclick="gotopage_up('stockBought',<s:text name='paper.max' />,<s:text name='paper.count' />,<s:text name="paper.size" />)" class="btn_gopage" >G0</b>
