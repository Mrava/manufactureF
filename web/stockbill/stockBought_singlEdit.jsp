...
<div class="listtit">
	<h2></h2>
	<b>单例到货计划.insert</b>
	<a href="/stockBought!list.action">返 回</a>
</div>
<div class="line"></div> 
	<div id="bb_material1" class="bbsearch"></div>
	<div id="bb_material2" class="bbsearch"></div>
	<div id="bb_material3" class="bbsearch"></div>
	<s:form action="stockBought" method="post" namespace="/" onsubmit="return inputValid()">
		<div >
		<s:token></s:token>
		<s:hidden name="pojo.id"></s:hidden>
		<s:hidden name="pojo.itemId" id="bomCode" label="bomId"></s:hidden>
		...
		<s:textfield name="pojo.client" id="client" label="供应商"></s:textfield>
		<s:textfield name="pojo.billno" id="billno" label="订单号"></s:textfield>
		<s:textfield name="pojo.remark" id="remark" label="备注"></s:textfield>
