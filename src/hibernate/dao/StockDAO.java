...
public class StockDAO extends HibernateDaoSupport
{
	...
	public Stock findById(java.lang.Integer id)
	{
		...
		try
		{
			Stock instance = (Stock) getHibernateTemplate().get("hibernate.dao.Stock", id);
			return instance;
		} catch (RuntimeException re)
		{
	...
	public Stock merge(Stock detachedInstance)
	{
		...
		try
		{
			Stock result = (Stock) getHibernateTemplate().merge(detachedInstance);
